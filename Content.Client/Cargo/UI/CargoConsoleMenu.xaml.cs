...
namespace Content.Client.Cargo.UI
{
    ...
    public sealed partial class CargoConsoleMenu : FancyWindow
    {
        ...
        public void UpdateBankData(string name, int points)
        {
            ...
            //SS14RU - start
            _currentBankBalance = points;
            PointsLabel.Text = FormatCurrency(points);
        }
        ...
        public void SetCurrency(string? currencyId)
        {
            ...
            UpdateCurrencyLabel();
            PointsLabel.Text = FormatCurrency(_currentBankBalance);
        }
        ...
        private void UpdateCurrencyLabel()
        {
            if (_currency == null)
            {
                BalanceLabel.Text = Loc.GetString("cargo-console-menu-points-label");
                return;
            }

            var currencyName = Loc.GetString(_currency.DisplayName);
            BalanceLabel.Text = Loc.GetString("cargo-console-menu-balance-label", ("currency", currencyName));
        }
        ...
        private string FormatCurrency(int amount)
        {
            ...
            if (_currency == null)
                return Loc.GetString("cargo-console-menu-points-amount", ("amount", amountText));

            var currencyName = Loc.GetString(_currency.DisplayName);
            return Loc.GetString("cargo-console-menu-currency-amount", ("currency", currencyName), ("amount", amountText));
        }
        //SS14RU - end
    }
}
