book-text-spacelaw =
        ...
        Хорошее понимание космических законов очень важно для любого члена станции. Глубокое знание законов требуется лишь от сотрудников ДШ, адвоката и ХоПа. Хотя маловероятно, что сотрудники ДШ будут слушать ваши протесты насчет неверно присвоенному вам коду - этого вполне может хватить, чтобы избежать большого срока и жесткого обращения с собой.
    ...
    Смотритель или Глава Департамента Шерифа несут ответственность за заключенных.
        ...
        Адвокаты и, соответственно, руководитель отдела кадров существуют для того, чтобы служить руководящей рукой и голосом разума в судебном процессе. Однако они не имеют никакой власти над бригадой, сотрудниками Департамента Шерифа, заключенными или вынесением приговора.
        Капитан или глава персонала имеют право быть судьями в уголовных делах. Но в случае гражданского иска судьей так же может быть глава Департамента Шерифа.
        Адвокат имеет доступ в радиоканал Департамента Шерифа, но ДШ не обязано выполнять его просьбы,и в случае злоупотребления каналом ДШ имеет право забрать у адвоката гарнитуру.
        ...
        Судебные разбирательства необязательно должны проводится, если улик и свидетельских показаний достаточно, чтобы сразу вынести приговор. Обычно суд нужен обвиняемому, чтобы отсрочить приговор, а поэтому не стоит тратить время на суд, в котором явно доказано преступление. В основном суды проводятся в рамках приговора обвиняемого к высшей мере наказания - смертная казнь. Подобный приговор может выносится ТОЛЬКО через суд либо по приказу капитана.
            ...
            Применение силы
        Как сотрудник Департамента Шерифа станции, вы - один из самых вооруженных и защищенных людей на станции, оснащенный почти новейшими технологиями не летального усмирения нарушителей. В подавляющем случае вам нужно использовать оглушающие нарушителя средства, но в некоторых обстоятельствах летальное оружие допустимо:
        ...
        Высокие риски во время задержания - попытка арестовать Ядерного Оперативника, скорее всего закончится смертью офицера ДШ поэтому, устранение летальным оружием будет оправдана.
        ...
        Кроме того, в случае попытки побега из брига офицер может выстрелить лазером через стекло. Ожидается, что сотрудник ДШ сначала сделает несколько предупредительных выстрелов, прежде чем разрядить оружие в цель.
    ...
    304 - Хищение или незаконное владение боевым оружием или взрывчаткой
        Без предварительного разрешения иметь при себе оружие, такое как: пистолеты, дубинки, флешки, гранаты и так далее. Под эту статью подойдет любой предмет, который может причинить серьезный урон или вывести из строя человека на значительное время. Сотрудники имеющие неограниченную лицензию на ношение холодного и огнестрельного оружия: капитан, глава персонала, Департамент Шерифа.
    ...
    309 - Умышленное игнорирование обязанностей
        ...
        Совершение данных преступлений может повлечь за собой пожизненное заключение, смертную казнь
            Только капитан, глава персонала и надзирать с главой Департамента Шерифа могут санкционировать пожизненное заключение
    ...
    Сотрудничество с ДШ - -25% от срока. Если человек назовет имена глав революции: Немедленное освобождение.
    ...
    Преследование подозреваемого - К его сроку прибавляется по одной минуте за каждые 2 минуты преследования.
        Если офицер ДШ преследует заключенного достаточно долго.
    Рецидив - В зависимости от ситуации.
         	ДШ в праве увеличить время за повторно совершенное преступление. В зависимости от тяжести статьи при нарушении 2 и более раз, вы можете оставить заключенного на пожизненное.
