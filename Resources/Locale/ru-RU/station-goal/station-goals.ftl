...
station-goal-combat =
    ...
    4. Провести набор нового боевого подразделения Департамента Шерифа. Состав отряда набирается из числа экипажа станции, на добровольно-принудительной основе. В состав должны входить:
        - 1 полевой медик;
        - 1 полевой инженер;
